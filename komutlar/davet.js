...
exports.run = (client, message) => {
  ...
  if (!message.guild) {
    ...
    .setColor(0xDF01A5)
        .addField('Botu Davet Et!', `[Tıkla!](https://discordapp.com/oauth2/authorize?client_id=574273237962194965&scope=bot&permissions=8)`, true)
        .addField('Destek Sunucusu!', `[Tıkla!](https://discord.gg/zMHAhCF)`)
