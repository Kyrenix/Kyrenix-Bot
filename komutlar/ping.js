...
exports.run = async (bot, message, args) =>
{
  ...
  .setDescription('<:x:508973336466948097> - Otorolü ayarlamak için bir rol etiketlemelisin. Otorol kanalıda ayarlamayı unutma! Bu arada rolü benden altta yapman lazım yoksa rolü veremem.')
  .setColor('RANDOM')
  ...
  if (message.guild.member(message.author.id).hasPermission(0x8))
    
    {
      ...
      if (!mentionedRole) return message.channel.send("**Doğru Kullanım = n!otorol @<roladı> #<metinkanalı>**".then(msg => msg.delete(5000)));
