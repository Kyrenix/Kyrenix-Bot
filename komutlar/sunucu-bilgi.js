...
exports.run = (client, message, params) => {
  ...
  var konum = ''
   ...
   .addField('» Roller ['+message.guild.roles.size+']', '`m!roller` yazarak görebilirsiniz.', true)
   .addField('» Emojiler ['+message.guild.emojis.size+']', '`m!emojiler` yazarak görebilirsiniz.', true)
