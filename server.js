...
client.ayarlar = {
	...
	prefix: "a!", // Ön-ek
	token: "NTc0MjczMjM3OTYyMTk0OTY1.XM2_3g.Up4ML6Cz9yIm6Sg0Hj7nHu2p2gE",
	klasor: "komutlar", // Komutların bulunduğu klasörün ismi
	renk: "#FF0000", // Embed rengi (HTML kodu veya RANDOM yazılabilir.)
	destek: "https://discord.gg/eWrH5X3", // Discord destek sunucunuz
	surum: "0.0.1", // Botunuzun sürümü
	site: "Site: Www.ApixSky.Com", // Botunuzun web sitesi
	yardimcilar: ["311559430300762113"], // İstenirse daha fazla eklenebilir. Eğer yoksa [] içi temizlenebilir.
	...
	oyun: "{prefix}yardım🔥a!davet🔥Play.ApixSky.Com", // Oynuyor yeri, Burayı dilediğiniz şekilde değiştirebilirsiniz.
	...
	durum: "bosta" // Botun durumu sadece rahatsizetmeyin veya cevrimici veya bosta yazabilirsiniz eğer bunlar dışında bir şey yazarsanız veya boş bırakırsanız direk çevrimiçi gözükecektir.
...
client.on('message', async msg => {
    ...
    .setTitle(' <:x:474973245477486612> | İlk Olarak Sesli Bir Kanala Giriş Yapmanız Gerek.'));
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle('Maxic BOT | Şarkı Seçimi')
   ...
   .setTitle(`:loud_sound: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle('Maxic BOT | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("**Maxic BOT | 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
...
client.on("guildMemberAdd", async member => {
 ...
 .setColor("GREEN")
  ...
  try {
    let giriscikiskanalID = giriscikis[member.guild.id].kanal;
    let giriscikiskanali = client.guilds.get(member.guild.id).channels.get(giriscikiskanalID);
    giriscikiskanali.send(`:loudspeaker: :inbox_tray: Kullanıcı Katıldı! **${sayac[member.guild.id].sayi}** Kişi Olmamıza **${sayac[member.guild.id].sayi - member.guild.memberCount}** Kişi Kaldı **${member.guild.memberCount}** Kişiyiz! :white_check_mark:  ${process.env.basarili} Hoşgeldin! **${member.user.tag}**` );
  } catch (e) { // eğer hata olursa bu hatayı öğrenmek için hatayı konsola gönderelim.
    return console.log(e)
  }
